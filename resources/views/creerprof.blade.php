    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav"  >
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{URL::to('/creerprof')}}" id="lis">
          ...
          <div class="card  shadow justify-center mb-3" style="background-color:#fffffc;">
            <div class="card-header  border-0"  style="background-color:#111721;">
              <div class="row align-items-center" >
                <div class="col-10">
                <label class="  mb-4 display-4 text-white" >Créer un compte d'un enseignant</label>
                </div>
                
              </div>
            </div>
            <div class="card-body">
                    <form method="POST" action="{{URL::to('/Sauvprof')}}">
                    {{csrf_field()}}
                  ...
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                        <div class="col-lg-2">
                            <label for="email" class="form-label text-nowrap text-dark">{{ __(' la spécialité') }}</label></div>
                            <div class="col-lg-10">
